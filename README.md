...
Data-science project that attempts to show how schedule load (rest, back-to-backs, travel) shifts NBA win probabilities. It fits a logistic GLM to historical games, computes counterfactual “neutral” win chances, and exports per-game schedule impact. Includes a forward-prediction script for testing.
